...
import DisplayTutoringEvent from "./DisplayTutoringEvent";
...
export default function DisplayTutoringEventCollection(props) {
    ...
    while ((newCache.length < cacheUntil || !isPaginated) && newNext != null) {
      ...
      const result = (
        await client.graphql({
          query: listTutoringEvents.replaceAll("__typename", ""),
          variables,
        })
  ...
  return (
    <div>
      <Collection
        ...
        {...getOverrideProps(overrides, "DisplayTutoringEventCollection")}
        {...rest}
      >
        {(item, index) => {
          if (loading) {
